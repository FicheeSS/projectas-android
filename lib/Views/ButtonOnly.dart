...
class _ButtonOnlyState extends State<ButtonOnly> {
  ...
  Future<Widget> createPlayerControls(BuildContext context) async {
    ...
    ElevatedButton btnKill = ElevatedButton(
        ...
        onPressed: isKillEnable
            ? fctCallBack
            : null, // si le bool est vrai on lance la fctCallBack sinon le btn est disable (null)
    ...
    var listeTemp = await updateAbilities(
        context); // le reste des abilité est donné par l'API
